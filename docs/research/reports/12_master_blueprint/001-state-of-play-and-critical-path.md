...
| **Verified fact** | Every licence in the stack · MADLAD/NLLB parameter counts · CTranslate2 architecture support · 15,053 cleanly-licensed documents · ~~**0**~~ **2,030** cleanly-licensed parallel sentences *(corrected 2026-09-01 — HornMT, CC-BY-4.0)* |
