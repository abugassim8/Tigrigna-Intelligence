...
| **Coverage** | ⚠️ **QUALIFIED** | **384/384** produce output, but that is **not phoneme coverage** — corrected 2026-08-23. Only **310 of 384** transliterate to phonemes; 74 pass through, of which **16 real syllables and 3 combining marks** are genuinely unmapped (DEC-022). "Zero gaps" was wrong |
