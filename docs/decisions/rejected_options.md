...
| NLLB-200 as the production translation model | DEC-011 | 2026-08-10 | **CC-BY-NC-4.0** — unshippable. Would pass an inherited restriction to downstream users (P-9, A-009), despite being the field's de facto Tigrinya baseline |
| "NLLB now, swap it later" | DEC-011 | 2026-08-10 | Deferring a licence problem does not shrink it — it moves it to the point where the API, published evaluations, and docs all assume the model that must be removed |
| MADLAD-400-7B / 10B | DEC-011 | 2026-08-10 | 3.9–5.0 GB at Q4 versus 1.4 GB for the 3B, with **no measured quality justification** for the cost (A-008) |
| Waiting on A-01 before deciding model strategy | DEC-011 | 2026-08-10 | A-01 concerns the unlicensed `fgaim` models; `fgaim` publishes **no MT model**. Translation was answerable the whole time |

| Decomposing services by domain | DEC-013 | 2026-08-10 | Ignores the measured ~150x resource spread — the thing that actually determines deployment cost |
| One container serving all capabilities | DEC-013 | 2026-08-10 | 1.6 GB resident just to normalise a string; multi-second cold start on microsecond operations |
| Keeping all tiers warm | DEC-013 | 2026-08-10 | Pays idle cost for 1.4 GB continuously at low volume (A-008) |
| Scaling all tiers to zero | DEC-013 | 2026-08-10 | Multi-second cold start on tokenization, which should take microseconds |
| Service-first, extract libraries later | DEC-012 | 2026-08-10 | Imposes infrastructure on the developer users DEC-002 names as primary; and the extraction never happens once services exist |
| Services-only (no libraries) | DEC-012 | 2026-08-10 | Makes the primitives unusable without infrastructure — fails the users who most need them |
| `llama-cpp-python` as the model runtime | DEC-014 | 2026-08-10 | Serves MADLAD GGUF but not the Roberta encoder — two runtimes where one suffices (P-7) |
| `transformers` as the serving runtime | DEC-014 | 2026-08-10 | Heaviest option with no native int8 CPU path; poorest fit for A-008 |

| Leaving DEC-008 screening as written policy | DEC-015 | 2026-08-13 | Measured outcome: three ad-hoc reimplementations, zero files in scripts/data_processing, enforced by nobody |
| Auto-detecting dataset licences | DEC-015 | 2026-08-13 | A licence is a legal fact about a dataset, not a property of its bytes |
| Passing contamination when no eval set is supplied | DEC-015 | 2026-08-13 | Silence would read as clearance — the exact failure DEC-008 exists to prevent |
| An automated column-scramble verdict | DEC-015 | 2026-08-13 | Not reliably separable from unusual prose; a false verdict is worse than a review flag |
| A training-centred ML pipeline | DEC-015 | 2026-08-13 | We decided not to train (A-004, A-005, DEC-003); it would invest where there is no work and under-invest in screening and evaluation |
| Prose-only experiment results | DEC-016 | 2026-08-13 | Measured: makes drift undetectable and P-5 unverifiable — the actual state of Experiment 001 |
| A full experiment-tracking system | DEC-016 | 2026-08-13 | Far too heavy for three experiments; would be abandoned, per DEC-001's reasoning |

| Training a Tigrinya MT model from scratch | DEC-017 | 2026-08-17 | A-002's ~40M-token ceiling is the entire open corpus; our lawful share is a fraction. Not a resource question — not possible |
| Fine-tuning on the 1.4M unlicensed en–ti pairs | DEC-017 | 2026-08-17 | Unlicensed (P-9, A-009); shipping the result would pass on rights we do not hold |
| Fine-tuning on FLORES+ or TiQuAD | DEC-017 | 2026-08-17 | They are our evaluation anchors — training on them is contamination (DEC-008) and destroys our only measurement |
| Full fine-tune as the default adaptation method | DEC-017 | 2026-08-17 | 23x LoRA's memory for no measured benefit; fails A-008 |
| Training because output "looks bad" | DEC-017 | 2026-08-17 | A-004 puts the burden of proof on the proposer — no training without a measured deficit against a pre-committed threshold |

| Relying on review discipline to enforce decision-log rules | DEC-018 | 2026-08-17 | Already measured to fail — DEC-008 was policy with no mechanism for 15 days and silently ignored |
| Automating enforcement of judgement calls | DEC-018 | 2026-08-17 | Not mechanically checkable; would produce false failures until someone disabled the workflow |
| Fixing Tier 2 as scale-to-zero now | DEC-019 | 2026-08-17 | Break-even may be ~1 req/min at slow cold start, where scale-to-zero is both slower and dearer. Unmeasured |
| Fixing Tier 2 as always-warm now | DEC-019 | 2026-08-17 | Wastes 1,162.9 GB-h/month at genuinely low volume (A-008) |
| Costing infrastructure in dollar figures | DEC-019 | 2026-08-17 | Vendor pricing unverifiable from this environment and volatile; GB-hours and break-even rates survive price changes |
| Kubernetes or a comparable orchestration layer | DEC-019 | 2026-08-17 | Three tiers, one runtime, low volume — a continuous expense buying nothing (P-7) |
| GPU infrastructure | DEC-019 | 2026-08-17 | DEC-014's runtime is CPU int8, and DEC-017's training is blocked on data rather than hardware |

| A single project-wide licence | DEC-020 | 2026-08-17 | Data derivatives carry share-alike obligations code does not; one licence either over-restricts code or under-honours upstream data terms |
| GPL / AGPL for source code | DEC-020 | 2026-08-17 | Nothing upstream requires it, and it would restrict the application developers DEC-002 names as primary users |
| MIT for source code | DEC-020 | 2026-08-17 | Apache-2.0's explicit patent grant matters more for infrastructure others build on; the surrounding ecosystem already uses it |
| Deferring the licence choice further | DEC-020 | 2026-08-17 | Deferred pending A-01/A-05/A-06, but the code licence turns out to depend on none of them |
| Proposing a revenue model | DEC-020 | 2026-08-17 | N-9 forecloses a commercial service for now; inventing one would contradict a recorded non-goal |
| Treating funding as the main sustainability risk | DEC-020 | 2026-08-17 | Measured cost is 52.6 GB-h/month for the always-warm tier — the scarce resource is maintainer attention, not money |

| Building translation next because it is the cleared capability | DEC-021 | 2026-08-17 | Follows P-4 literally but abandons DEC-006's reasoning; the primitives gap is our differentiator and translation has a strong incumbent |
| Revisiting DEC-006 to make translation the MVP | DEC-021 | 2026-08-17 | The gap-filling argument still holds, and 05_architecture independently confirmed the MVP is also the cheap tier — 191 MB against 1,593 MB |
| Building MVP primitives without evaluation | DEC-021 | 2026-08-17 | Violates P-4 directly — unmeasurable capabilities cannot be improved or defended, and failures could not be localised |
| Treating the anchor/MVP mismatch as a sequencing accident | DEC-021 | 2026-08-17 | It is structural: DEC-005's anchors do not cover DEC-006's platform and never would have |

| Deferring all of 07_api_mcp to A-02 | DEC-022 | 2026-08-18 | A-02 blocks the surface, not the contract — and the contract is the part that is expensive to change once consumers exist |
| UTF-8 byte offsets | DEC-022 | 2026-08-18 | Natural in Python, wrong for every JS client; 3–4 bytes per Ge'ez character also makes them unreadable when debugging |
| UTF-16 code-unit offsets | DEC-022 | 2026-08-18 | Natural in JS, wrong in Python, and inherits the surrogate-pair split precisely at Ethiopic Extended-B |
| Leaving the offset unit implicit | DEC-022 | 2026-08-18 | The divergence is silent and appears only on rare characters — the worst failure profile available |
| Uniform latency expectations across endpoints | DEC-022 | 2026-08-18 | A 150x spread; one client timeout either aborts valid translations or hangs on a tokenize call |
| `null` for unknown Tigrinya variety | DEC-022 | 2026-08-18 | Invites clients to ignore the distinction DEC-010 exists to preserve; `unknown` is the common case, not an absence |
| Describing the analysis form as phonemes | DEC-022 | 2026-08-18 | Measurably false for 19 real characters and for three entire Ethiopic blocks |

| Building a Tigrinya primitives benchmark before evaluating anything | DEC-023 | 2026-08-18 | Months of work (A-006) when three of four intrinsic properties are measurable today with no annotation |
| Character-level surface<->analysis offsets | DEC-023 | 2026-08-18 | Measurably impossible — 23.89% of words align; epitran resolves epenthetic vowels from cross-character context supplying 16.3% of output |
| Accepting a tradeoff between alignment and phonology | DEC-023 | 2026-08-18 | A false dilemma I proposed and then refuted by measurement — word-level gives exact alignment. **The 'full fidelity' half was retracted 2026-08-19** (DEC-023 Amendment 1): 1,639/1,639 came from a containment test; exact equality gives 95.47% |
| Treating intrinsic properties as sufficient evaluation | DEC-023 | 2026-08-18 | They catch broken, not wrong; a deterministically incorrect transliterator passes every one of them |
| Skipping evaluation and building the primitives directly | DEC-023 | 2026-08-18 | Violates P-4 — and H3 is precisely the class of error that surfaces only when you check |
...
| FLORES+ bitext retrieval for embeddings | DEC-026 | 2026-08-23 | **Impossible, not merely unavailable** — `tiroberta-bi-encoder` is monolingual, so embedding English measures tokenizer collisions rather than meaning |
| Building a Tigrinya STS set before evaluating embeddings | DEC-026 | 2026-08-23 | Months of annotation (A-006) when six properties are measurable today with none |
| Adopting a multilingual encoder instead | DEC-026 | 2026-08-23 | Would enable G-4, but is an undecided Tier 1 scope change and abandons a cleared Apache-2.0 model. Recorded as open, not rejected outright |
...
| Building our own evaluation set instead | DEC-029 | 2026-09-02 | Months of annotation (A-006). DEC-023 exists precisely to avoid this, and HornMT removes the urgency |
| Continuing to pursue the 1.4M corpus as the primary lead | DEC-030 | 2026-09-02 | It is a **re-upload of OPUS NLLB mined bitext** — no uploader can license it — and a published fine-tune on that pool scored en→ti chrF **4.99** |
| Treating "no licence stated" as permissive for the 1.4M | DEC-030 | 2026-09-02 | Inverts **P-9**. Absence of a licence is absence of a grant, and this corpus's absence is a re-upload artefact rather than a claim by anyone |
| Accepting Travis Foundation's declared CC-BY-SA-4.0 | DEC-030 | 2026-09-02 | 126,930 pairs, but its own card states the authors **do not own** the majority. A licensor cannot grant rights it does not hold — the failure A-06 exists to prevent, at 60× the scale |
